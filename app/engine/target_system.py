...
class TargetSystem():
    ...
    def _get_mari_loadout_nids(self, unit: UnitObject) -> List[str]:
        # Return the validated list of spell nids currently sitting in Mari's loadout
        # (filtered against the MariSpell catalog). Empty list for everyone else.
