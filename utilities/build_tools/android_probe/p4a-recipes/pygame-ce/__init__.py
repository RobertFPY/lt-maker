...
class PygameCERecipe(CompiledComponentsPythonRecipe):
    """Cross-compile pygame-ce against python-for-android's SDL2 libraries.

    This phase-1 recipe intentionally stays close to python-for-android's
    built-in pygame 2.1.0 recipe. It is a feasibility candidate, not yet a
    production-supported LT Maker dependency.
    """
    ...
    patches = ["setup-setuptools-distutils-spawn.patch"]
